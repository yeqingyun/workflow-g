...
/**
 * The class <code>RfcSapReqRelease</code>
 * 调用SAP接口进行取消审批
 * @author lipw
 * @version 1.0
 */
public class RfcSapReqRestRelease {
	
	private static final Logger logger = LoggerFactory.getLogger(RfcSapReqRestRelease.class);
	 ...
	 * @return
	 */
	public Map<String,String> sapReqSheetResetAudi(String preqNo, String preqItem, String relCode) {
		Map<String,String> errorMsgMap = new LinkedHashMap<String,String>();
		
		JCoFunction function = RfcManager.getFunction("BAPI_REQUISITION_RESET_RELEASE");
		if (function == null){
