package com.gionee.gniflow.web.servicetask.salaryprove;
 ...
 * @version 1.0
 */
public class SalaryProveNoticeServiceTask implements JavaDelegate {
	
	private static final Logger logger = LoggerFactory.getLogger(SalaryProveNoticeServiceTask.class);
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		processHelpService.sendEmail4UserAccount(Arrays.asList(startUser), "收入证明邮件提醒", "收入证明邮件提醒内容!");
