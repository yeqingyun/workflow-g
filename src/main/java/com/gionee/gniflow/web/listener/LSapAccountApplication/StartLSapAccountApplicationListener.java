...
public class StartLSapAccountApplicationListener implements ExecutionListener{
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		String accountDescribe  = (String)runtimeService.getVariable(execution.getId(), "accountDescribe");
