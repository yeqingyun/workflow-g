package com.gionee.gniflow.web.listener.LSapAccountApplication;
...
public class UpdateLSapAccountApplicationListener implements ExecutionListener{
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		String programOpt  = (String)runtimeService.getVariable(execution.getId(), "updateprogramOpt");//项目
		...
		if(programOpt.equals("3")){
			...
			if(hrUser.getEmpId()!=Integer.parseInt("2637")){
				...
				String content = "<p>彭昶昕，您好:</p><p style='padding-left:2em'>"+name+"发起了SAP账号申请流程（流程编号："+processInstanceId+"；账户申请描述："+accountDescribe+"),请及时确认！</p><p>此邮件由<a href='http://flow.gionee.com' target='_blank'>Gionee工作流平台</a>自动生成，请勿回复此邮件!</p> ";
