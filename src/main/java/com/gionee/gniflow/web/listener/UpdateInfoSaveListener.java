...
public class UpdateInfoSaveListener  implements ExecutionListener  {



	private Logger logger = LoggerFactory.getLogger(UpdateInfoSaveListener.class);
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		String reqChannels  = (String)runtimeService.getVariable(execution.getId(), "updateReqChannels");
		//奖惩类别
		...
		//奖惩分数
		String rpScore  = (String)runtimeService.getVariable(execution.getId(), "updateRpScore");
		//奖惩总金额
		String showMoneySum  = (String)runtimeService.getVariable(execution.getId(), "updateShowMoneySum");
        //备注
