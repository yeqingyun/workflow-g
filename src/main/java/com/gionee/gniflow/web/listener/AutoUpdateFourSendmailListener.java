...
public class AutoUpdateFourSendmailListener implements ExecutionListener {
	private static final long serialVersionUID = 1L;
	private Logger logger = LoggerFactory
			.getLogger(AutoUpdateFourSendmailListener.class);
	...
	public void notify(DelegateExecution execution) throws Exception {
		...
		logger.debug("Running in AutoUpdateFourSendmailListener begin!");
