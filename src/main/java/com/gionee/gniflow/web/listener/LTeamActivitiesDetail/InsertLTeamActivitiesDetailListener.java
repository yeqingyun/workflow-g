...
public class InsertLTeamActivitiesDetailListener implements ExecutionListener{
	/**
	 * 插入参加活动人员名单
	 */
	private static final long serialVersionUID = 4358779360859450714L;
	private Logger logger = LoggerFactory.getLogger(InsertLTeamActivitiesDetailListener.class);
	@SuppressWarnings("unchecked")
	@Override
	public void notify(DelegateExecution execution) throws Exception {
		logger.debug("Running in InsetLTeamActivitiesDetailLister begin!");
		...
		logger.debug("Running in InsetLTeamActivitiesDetailLister end!");
	}
}
